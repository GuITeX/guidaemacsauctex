...
% OI 2013/01/31: per ora scrivo qui il file di inizializzazione perché viene
% citato più volte, poi vediamo dove è oppurtuno spiegarlo.
...
\begin{itemize}
  %%% CONTROLLARE SU WINDOWS XP, VISTA, 8
\item Su Windows 7, va posizionato in \ldots
\item Su GNU/Linux, il file di inizializzazione deve avere percorso
  \verb|~/.emacs|, \verb|~/.emacs.el| oppure \verb|~/.emacs.d/init.el|;
\item Su MAC OS, \ldots
\end{itemize}
...
%% Con TeX Live è così, da verificare con MiKTeX.
...
\href{http://ftp.gnu.org/pub/gnu/auctex/auctex-11.87.tar.gz}%
{auctex-11.87.tar.gz}.
