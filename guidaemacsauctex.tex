...
\ProvidesFile{guidaemacsauctex.tex}[2014/01/29 v.1.1.9 Breve guida all'uso di Emacs per LaTeX]
...
\item[Windows XP] \filestyle{~/.emacs.d/init.el}
\item[Windows Vista/7] \filestyle{~/.emacs.d/init.el} o \filestyle{~/.emacs}
\item[GNU/Linux, Mac~OS] \filestyle{~/.emacs}, \filestyle{~/.emacs.el} o
      \filestyle{~/.emacs.d/init.el}
\end{description}
