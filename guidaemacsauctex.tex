...
\begin{itemize}
  % 0. Sulla formattazione al momento non mi viene nulla in mente :-(
  % 1. Ho dovuto usare \verb|...| perché \lstinline{...} non funziona con £
...
necessario utilizzare il programma \progstyle{make}.  \progstyle{make} viene installato
...
soltanto a chi sviluppa software può sfuttare il fatto che \progstyle{make} viene
