...
\menu[,]{Tools,Spell Checking,Automatic spel  checking (Flyspell)};
%\texttt{Tools > Spell Checking > Automatic spell
%  checking (Flyspell)}; %
se invece la si vuole tenere sempre abilitata si deve
aggiungere la riga:
\begin{Verbatim}
