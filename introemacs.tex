...
\ProvidesFile{introemacs.tex}[2012/12/12 v.0.0 Breve guida all'uso di Emacs per LaTeX]
...
\begin{itemize}
\item[\ccAttribution] Devi attribuire la paternità dell'opera nei modi indicati
...
\item[\ccNonCommercial] Non puoi usare quest'opera per fini commerciali.
\item[\ccShareAlike] Se alteri o trasformi quest'opera, o se la usi per crearne
...
In questo articolo vengono brevemente presentati il programma \emacs{} ed il
pacchetto \auctex{} per le principali piattaforme: Windows, GNU/Linux e Mac
OS. Dopo una introduzione ai programmi, verranno esposte le modalità per poter
installare e configurare \emacs{} e \auctex{} per poter scrivere documenti
\LaTeX{}. L'articolo non ha la pretesa di essere un manuale, bensì un piccolo
tutorial per far avvicinare gli utenti di \LaTeX{} a questo programma, non così
troppo complicato come spesso viene indicato.

La realizzazione di questo lavoro a sei mani si è resa possibile
...
\textcolor{red}{MODIFICARE \lipsum[2]}
...
\chapter{Installare \emacs}
\label{chap:install}

\section{\emacs{} per Windows}
...
\chapter{Ricerca diretta-inversa}
\label{chap:ricdirinv}
...
\section{Ricerca diretta-inversa su Windows}
\label{sec:fiswin}
...
\section{Ricerca diretta-inversa su GNU/Linux}
\label{sec:fislinux}

\textcolor{red}{\lipsum[1]}

\section{Ricerca diretta-inversa su Mac OS}
\label{sec:fismac}
