...
\newcommand*{\myDraft}[1]{{%
 \sffamily\LARGE%
  \textcolor{blue}{\textbf{BOZZA: \today}. %
  Per informazioni:
  \sito{http://www.guitex.org/home/it/forum/6-altri-programmi/67205-gnu-emacs-lavori-in-corso\#67205}{GNU
  Emacs - Lavori in corso}}}
}%

\usepackage{eso-pic} 
\AddToShipoutPictureBG{%
  \begin{picture}(0,0)\unitlength=1cm\relax
   \put(1,5){\rotatebox{90}{\makebox(0,0)[l]{\myDraft}}}
  \end{picture}%
}
%%%
%%% TEMP
...
%%
%% 2012/09/05: [TODO] PARLARE BREVEMENTE ANCHE DI AUCTEX
%%
...
%%
%% 2012/08/19: Quasta modifica dovrebbe valere per tutti e tre i sitemi operati:
%%             si potrebbe pensare di metterla in testa al paragrafo per poi
%%             specificare le procedure "vecchie".
