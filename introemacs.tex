...
\newcommand*{\myDraft}[1]{{%
 \sffamily\LARGE%
  \textcolor{blue!50}{\autori\ --- \textbf{BOZZA: \today}. %
  Per informazioni:
...
\AddToShipoutPictureBG{%
  \begin{picture}(0,0)\unitlength=1cm\relax
   \put(1,0.2){\rotatebox{90}{\makebox(0,0)[l]{\myDraft}}}
  \end{picture}%
}
%%%
%%% TEMP
...
%% si potrebbe pensare di metterla in testa al paragrafo per poi specificare le
%% procedure "vecchie".
