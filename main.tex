...
permettono tale funzione. In [rif. Pantieri-Gordini] vengono citate le
...
interagire con il file sorgente \textsf{.tex} creato con \emacs{} è SumatraPDF
...
e copiarlo in una cartella accessibile ad \emacs{} (l'autore delle note
...
Fatto questo resta da far capire ad \emacs{} che si vuole la ricera
...
\begin{verbatim}
 ...
 '(TeX-view-program-selection (quote ((output-pdf "SumatraPDF") (output-dvi "Yap") (output-html "start"))))
\end{verbatim}
