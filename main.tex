...
\label{sec:lic}
\mettifigura{\includegraphics[height=17pt]{by-nc-nd}\hspace{2mm}}\noindent 
Quest'opera è soggetta alla Creative Commons Public License versione 3.0
o posteriore: Attribuzione - Non commerciale - Non opere
derivate. L'enunciato integrale della Licenza in versione 3.0 è
reperibile sul sito ufficiale
(\mano{}~\href{http://creativecommons.org/licenses/by-nc-nd/3.0/deed.it}{CC
By-Nc-Nd}).
\end{document}
