...
in più file da includere nel file principale con i comandi \verb!\input! o
\verb!\include! può essere utile aggiungere al file \verb!.emacs!
\begin{Verbatim}
...
\mettifigura{%
  \includegraphics[height=19pt, width=54.3pt]{gitlogo}\hspace{2mm}}\noindent 
La realizzazione di questo lavoro a sei mani si è resa possibile grazie al
sistema di controllo di versione Git~\sito{http://git-scm.com/}{Git - Fast
  Version Control System}. È gradita la segnalazione di errori o refusi.Per
poter collaborare si può clonare il progetto tramite il sito Gitorius con 
\verb!git clone git://gitorious.org/emacs-tutorial/emacs-tutorial.git!
\end{document}
