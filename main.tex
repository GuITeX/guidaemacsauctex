...
{\auctex}, si scarica l'archivio compresso \href{%
...
{\auctex} bisogna scaricare l'archivio
...
\sito{http://aspell.net/win32/}{ \textsf{GNU Aspell - Win32
...
\textsf{SumatraPDF}
\sito{http://blog.kowalczyk.info/software/sumatrapdf/free-pdf-reader.html}{SumatraPDF}.
...
\sito{http://william.famille-blum.org/software/sumatra/sumatra-forward.el}{sumatra-forward.el}
...
(\href{http://creativecommons.org/licenses/by-nc-sa/3.0/deed.it}{CC
  By-Nc-Sa}).
\end{document}
