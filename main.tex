...
C:/Programmi/emacs/
\end{Verbatim}
La cartella appena creata contiene i file riportati in~\ref{tab:fileemacs}.
\begin{table}[t]
\centering
\begingroup\ttfamily
...
C:/Programmi/emacs/
\end{Verbatim}
Sia nell'archivio di \auctex{} (tabella~\ref{tab:fileauc}), che quello di
\emacs{} (tabella~\ref{tab:fileemacs}), posizionato in 
...
\section{Personalizzare \emacs{} }  % titolo cambiato per avere un
                                % effetto migliore nell'indice, ma in
                                % realtà non mi piace
\label{sec:personal}
...
\begin{figure}[t]
  ...
  \begin{picture}(200,120)
    \put(0,0){\framebox(94,120){\includegraphics[width=0.51\textwidth]{refemacs}}}
    ...
    \put(100,0){\framebox(94,120){\includegraphics[width=0.51\textwidth]{refauctex}}}
...
o posteriore: Attribuzione - Non commerciale - Condividi allo stesso modo. L'enunciato integrale della Licenza in versione 3.0 è
...
=======
>>>>>>> parent of deec445... File inizializzati
